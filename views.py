...
def getTime(doctor): 
    ...
    con = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = '', database = 'HospitalDB',charset='utf8')
    with con:
        cur = con.cursor()
...
def PrescriptionAction(request):
    ...
    db_connection = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = '', database = 'HospitalDB',charset='utf8')
